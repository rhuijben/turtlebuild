...
namespace TestResources
{
	class Program
	{
		...
		{
			Uri uri = new Uri(typeof(Program).Assembly.CodeBase);
			string file = uri.LocalPath;

			File.Copy("E:/dev/sharpsvn/src/SharpSvn/bin/debug/SharpSvn.dll", "f:\\sharpsvn.dll", true);

			//Assert.That(file, Is.Not.Null);
		//	TurtleCppHelper.UpdateVersionInfoFromAttributes("f:\\sharpsvn.dll", null);
		}
