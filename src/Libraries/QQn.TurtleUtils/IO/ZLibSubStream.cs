...
[module: SuppressMessage("Microsoft.Design", "CA1004:GenericMethodsShouldProvideTypeParameter", Scope = "member", Target = "QQn.TurtleUtils.IO.ZLibSubStream.GetService():T")]
...
namespace QQn.TurtleUtils.IO
{
	...
	/// </summary>
	public class ZLibSubStream : DeflateStream, IServiceProvider
	{
		/// <summary>
		...
		public ZLibSubStream(Stream stream, CompressionMode mode)
			: base(stream, mode)
		{
		}
		...
		public ZLibSubStream(Stream stream, CompressionMode mode, bool leaveOpen)
